...
export DOCKERDEV_ENGINE_IP=127.0.0.1
export DOCKERDEV_HOST_IP=172.17.0.1

export DISPLAY=:0
#Added for fresh Oracle 12c Installation
export ORACLE_HOSTNAME=gomer
...
alias gephi='LIBGL_ALWAYS_SOFTWARE=1 ~/gephi-0.9.1/bin/gephi'
alias weather='ansiweather -l ramona -u imperial -d t -f 5'
...
export BASH_IT="/home/eric/.bash_it"
